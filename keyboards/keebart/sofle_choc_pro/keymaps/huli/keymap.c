...
[GAME] = LAYOUT_split_4x6_5(
  ...
  KC_B,     KC_LCTL,  KC_Z,   KC_X,    KC_C,    KC_V,   _______,     _______, KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RBRC,
                KC_PSCR, KC_ESC, KC_LALT, MO(FUNC), KC_SPC,      KC_ENT,  MO(EXTRA), KC_RCTL, KC_RALT, KC_RGUI
),
