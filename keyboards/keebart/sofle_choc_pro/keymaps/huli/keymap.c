...
[BASE] = LAYOUT_split_4x6_5(
  ...
  KC_LSFT,  KC_Z,   KC_X,   KC_C,   KC_V,   KC_B, TG(GAME),         TG(NUM),KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH,KC_RBRC,
...
[GAME] = LAYOUT_split_4x6_5(
  ...
  KC_M,     KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,   _______,     _______, KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RBRC,
...
[EXTRA] = LAYOUT_split_4x6_5(
  ...
  _______, TO(BASE), TO(SPCENT), TO(FUNC), XXXXXXX, XXXXXXX,                KC_PGUP,  KC_INS,  KC_UP,   KC_DEL, C(KC_BSPC), KC_BSPC,
...
void set_spcent_key_color(void) {
    rgb_matrix_set_color_all(DEFAULT_RGB);
    set_single_key_color(true, 1, 100, 0, 0); // Space
    set_single_key_color(false, 1, 100, 0, 0); // Enter
};
...
void set_extra_key_color(void) {
    ...
    set_single_key_color(true, 23, 100, 0, 0); // Undo
    set_single_key_color(true, 19, 0, 100, 0); // Redo
    set_single_key_color(true, 22, 100, 0, 0); // Cut
    set_single_key_color(true, 20, 100, 100, 0); // Copy
    set_single_key_color(true, 13, 0, 100, 0); // Paste
    set_single_key_color(true, 26, 0, 100, 0); // ALT+F4
};
